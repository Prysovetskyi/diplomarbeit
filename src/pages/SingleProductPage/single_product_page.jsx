...
import NotFoundPage from '../NotFoundPage/not_found_page';
...
const SingleProductPage = () => {
  ...
  useEffect(() => {document.title = `Product: ${title}`;},[title]);

  const onClickAdd = () => {dispatch(addToBasket(product.item.id));
          ...
          <div className={s.product_card}>
            ...
            <div className={s.product_info}>
              <div className={s.actions}>
                ...
                <button onClick={onClickAdd} className={s.add_btn}>To cart
                </button>
              </div>
              ...
              <div className={s.mob_descr}>title={'Description'}{description}
              </div>
            </div>
          </div>
        </div>
